...
public class TestPlayfield extends JPanel
{
		...
		public  void closeGame()
        {
        	...
        	while(iter.hasNext())
        	{
        	 ...
        	 LinkedHashMap<Integer, Integer> rankplayers = theGame.getRankedPlayerIds();
        	 Set set1 = rankplayers.entrySet();
         	Iterator iterator = set1.iterator();
           //  Iterator iterator = rankplayers.keySet().iterator();  
             
             while (iterator.hasNext()) {  
//                Integer key = iterator.next();  
//                Integer value = rankplayers.get(key).toString();  
